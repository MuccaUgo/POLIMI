...
(function () {
  ...
  function toggleTheme() {
    ...
    if (meta) meta.content = next === "dark" ? "#12121c" : "#3b3468";
    syncThemeButton();
  }
  ...
  /* ---------------- quiz ---------------- */
  function sessionKey(mode) { return "sm_session_" + mode; }
  ...
  function recordCompletion(correct, total, wrongItems, mode, completedId) {
    ...
    if (navigator.locks && navigator.locks.request) {
      navigator.locks.request("sm_record_completion", record).catch(record);
    } else record();
  }
  ...
  function celebrate() {
    ...
    var colors = ["#3b3468", "#554c9c", "#8d86d6", "#e0b779", "#4fb3c8", "#c4554b"];
    var box = document.createElement("div");

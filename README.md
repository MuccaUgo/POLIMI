...
| [`sm/`](sm/) | Strategy & Marketing | **Introduction**: 39 concept cards, 31 questions — the company and its legal forms, ownership from foundation to IPO, shareholder and stakeholder value, corporate governance and ESG. **The Concept of Strategy** (chapter 1): 43 concept cards, 43 questions — what strategy is, its levels and the SBU, the strategic decisions process, intended against emergent strategy, and vision, mission, purpose and culture |
...
- **Concepts** — cards grouped by area, each with the meaning, how it works in practice and the typical exam
  trap. Searchable and filterable. Where the data declares more than one topic, as both hubs now do, a topic

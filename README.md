...
|---|---|---|
| [`afc/`](afc/) | Accounting, Finance & Control | The AFC26 programme and lecture calendar, plus a **two-chapter Prerequisites map** with 10 parts for each annexure. **Financial Accounting**: 44 concept cards, 83 questions — IFRS reporting: accrual principle and fair value, balance sheet, income statement, cash flow statement, notes and segmental reporting. **Cost Accounting**: 39 concept cards, 42 questions — cost objects and the three classifications, cost configurations, and the process, job order, operation and activity-based allocation methods |
